...
## Install
    ...
    ./bin/plugin install https://github.com/mats990/elasticsearch-prometheus-exporter/releases/download/2.3.4.3/elasticsearch-prometheus-exporter-2.3.4.3.zip
